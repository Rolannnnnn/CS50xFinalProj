...
Public Class BasketballMVP
    Private Sub BasketballMVP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim sql1 As String = "SELECT [Player Name] FROM Members WHERE [MemberId] > 0"

        Using connection As New SQLiteConnection(StringStorage.Addresser(StringStorage.SportsBasketballDatabase))
            connection.Open()
            ...
            Dim sql2 As String = "SELECT [Points], [Assists], [Rebounds] FROM Records WHERE [Player Name] = @pn"
            For i = 0 To count
