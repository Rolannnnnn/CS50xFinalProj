...
Public Class ESportsMVP
    Private Sub ESportsMVP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim sql1 As String = "SELECT [PlayerName] FROM Players WHERE [PlayerId] > 0"
        ...
        Using connection As New SQLiteConnection(StringStorage.Addresser(StringStorage.SportsEsportsDatabase))
            ...
            Dim sql2 As String = "SELECT [Kills], [Deaths], [Assists] FROM Records WHERE [PlayerName] = @pn"
            For i = 0 To count
