...
Public Class AccountForgotPassword
    ...
    Private Sub sendEmail(address As String, code As Integer)
        Try
            ...
            Dim body As String = "To complete resetting your password, use this OTP: " & code & ". Thank you." & vbCrLf & vbCrLf & vbCrLf & vbCrLf & "This is a system-generated email. No need to reply."
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            ...
            ElseIf Not OTPTB.Text = sentcode.ToString Then
                ...
                StringStorage.ShowLabelsForThreeSeconds(FeedbackLbl)
            Else
                Dim sql As String = "UPDATE [Users] SET [Password] = @pass WHERE [Email] = @email"
                Using connection As New SQLiteConnection(StringStorage.Addresser(StringStorage.SecurityDatabase))
                    connection.Open()
                    Using command As New SQLiteCommand(sql, connection)
                        command.Parameters.AddWithValue("@pass", BCrypt.Net.BCrypt.HashPassword(PasswordTB.Text))
